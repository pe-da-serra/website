...
import region6 from '@/assets/region-6-lg.jpg';
import region7 from '@/assets/region-7-lg.jpg';
import region8 from '@/assets/region-8-lg.jpg';
...
const images = ref([
  ...
  { source: region6, tags: [ Tab.Region ] },
  { source: region7, tags: [ Tab.Region ] },
  { source: region8, tags: [ Tab.Region ] },
