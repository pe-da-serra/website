  ...
  <v-row justify="center">
    <v-col md="10" xl="7" class="px-sm-10 mt-sm-3">
      ...
      <v-row class="px-8 px-sm-0 mt-1 mb-5" justify="center">
        <v-col cols="12" md="8">
          <p class="text-h5 font-weight-medium">Triplo</p >
          <p class="text-subtitle-1">3 hóspedes • 3 camas</p>
          ...
          <v-row>
            <v-col>
              <v-list bg-color="background">
                <RoomFeature icon="mdi-bed-outline" text="3 camas de solteiro" />
